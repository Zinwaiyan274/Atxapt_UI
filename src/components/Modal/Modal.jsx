              ...
              <div className="relative p-10 flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2">
                  ...
                  <a
                    href={props.siteLink}
                    target="__blank"
                    class={`relative px-5 py-3 text-sm md:text-base  overflow-hidden font-medium text-[${textColor}] bg-gray-100 border border-gray-100 rounded-lg shadow-inner group mx-4`}
